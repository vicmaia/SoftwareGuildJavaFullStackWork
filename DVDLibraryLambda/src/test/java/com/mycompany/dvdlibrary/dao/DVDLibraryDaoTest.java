...
public class DVDLibraryDaoTest {
    ...
    private DVDLibraryLambdaDao dao;


    public DVDLibraryDaoTest() {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext.xml");

        dao = ctx.getBean("dvdLibraryDao", DVDLibraryLambdaDaoFileImpl.class);
    }
...
//     */
    ...
    public void testGetAllDVDs() throws Exception {
        ...
        dvd1.setReleaseDate("01/01/1992");
        dvd1.setRating("R");
        ...
        dvd2.setReleaseDate("01/01/1992");
        dvd2.setRating("G");
