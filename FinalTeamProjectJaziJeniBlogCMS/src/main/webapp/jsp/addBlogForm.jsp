...
<html>
    ...
    <body>
        <div class="container myBackground">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="post" action="addBlog" enctype="multipart/form-data" method="POST">
                <div class="form-group myText">
                    ...
                    <div class="form-group myText" role="form" id="add-author">
                        ...
                        <div class="col-md-8">
                            ...
                            <c:forEach var="currentAuthor" items="${authorList}">
                                <c:choose>
                                    <c:when test="${pageContext.request.userPrincipal.name eq currentAuthor.firstName}">
                    ...
                    <div class="form-group myText" role="form" id="add-category">
                        ...
                        <div class="col-md-8">
                            ...
                            <c:forEach var="currentCategory" items="${categoryList}">
                                <c:choose>
                                    <c:when test="${currentCategory.categoryID eq post.category.categoryID}">
                    ...
                    <div class="form-group myText" role="form" id="add-item" method ="POST" action = "addItem">
