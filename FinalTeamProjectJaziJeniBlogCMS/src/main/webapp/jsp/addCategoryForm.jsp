...
<html>
    ...
    <body>
        <div class="container myBackground">
            ...
            <div>
                <c:if test="${message eq 'Duplicate Category name.'}">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="category" action="addCategory" method="POST">
                <div class="form-group myText">
                    <label for="add-category-title" class="col-md-4 control-label">Category Name:</label>
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="add-category-title"
                                  path="name" name="name" placeholder="Category Name"/>
                    ...
                    <div class="form-group myText">
                        ...
                        <sf:input type="text" class="form-control" id="add-category-description"
                                  path="description" name="description" placeholder="Category Description"/>
